                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    Text(" Noter l'école", style: GoogleFonts.dancingScript(fontSize: 24,fontWeight: FontWeight.bold, color: myColors[4]),),
                                  ],
                                ),
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      decoration: BoxDecoration(color: myColors[7].withOpacity(0.3), borderRadius: BorderRadius.circular(5)),
                                        child: Center(child: Text("OK", style: GoogleFonts.dancingScript(fontSize: 24,fontWeight: FontWeight.bold, color: myColors[7]),))),
                                    ),
                                  ],
                                ),
                              ],
