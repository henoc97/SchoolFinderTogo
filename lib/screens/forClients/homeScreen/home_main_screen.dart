          ...
          Container(
            ...
            child: Container(
              ...
              child: Column(children: [
                BlocBuilder<MenuCtlrCubit, double>(
                  builder: (context, state) {
                    return Row(
                      ...
                      children: [
                        IconButton(
                            onPressed: () {
                            state==0?  context.read<MenuCtlrCubit>().sateOne():
                            context.read<MenuCtlrCubit>().sateZero();
                            },
                            icon: Icon(
                              state==0? Icons.more_vert_outlined : 
                              ...
                              child: Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage(
                                            "assets/photos/avatar/7309681.jpg")),
                                    borderRadius:
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          PageRouteBuilder(
                              pageBuilder: (_, __, ___) => const HomeSearch()));
                    },
                    child: Container(
                  ...
                  SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Padding(
                          padding:
                              EdgeInsets.fromLTRB(12.0.w, 12.0.h, 12.0.w, 0),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Ecoles',
